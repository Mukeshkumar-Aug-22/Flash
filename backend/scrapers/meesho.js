...
//     // Meesho is React — wait longer for products to render
...
//     // Meesho product cards — try multiple selectors
//     const cardSelectors = [
...
//     // Fallback — find any div containing ₹ price and a product name
//     if (cards.length === 0) {
//       $('div').each((i, el) => {
//         const text = $(el).text();
...
//       if (title && price && price > 50 && title.length > 3) {
//         results.push({
//           site: 'Meesho',
